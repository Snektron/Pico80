...
FallbackDisplayRenderer::FallbackDisplayRenderer()
{
	initializeOpenGLFunctions();
	shader = new QOpenGLShaderProgram();
	shader->addShaderFromSourceFile(QOpenGLShader::Vertex, QStringLiteral(":/shader/FallbackDisplay.vsh"));
	shader->addShaderFromSourceFile(QOpenGLShader::Fragment, QStringLiteral(":/shader/FallbackDisplay.fsh"));
...
void FallbackDisplayRenderer::render()
{
	shader->bind();
